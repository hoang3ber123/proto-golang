...
type GetAllProductIDsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                // Lọc theo user_id nếu có
	RelatedType   string                 `protobuf:"bytes,2,opt,name=related_type,json=relatedType,proto3" json:"related_type,omitempty"` // Lọc theo related_type nếu có
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetAllProductIDsRequest) Reset() {
	*x = GetAllProductIDsRequest{}
	mi := &file_order_order_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAllProductIDsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllProductIDsRequest) ProtoMessage() {}

func (x *GetAllProductIDsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_order_order_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllProductIDsRequest.ProtoReflect.Descriptor instead.
func (*GetAllProductIDsRequest) Descriptor() ([]byte, []int) {
	return file_order_order_proto_rawDescGZIP(), []int{7}
}

func (x *GetAllProductIDsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *GetAllProductIDsRequest) GetRelatedType() string {
	if x != nil {
		return x.RelatedType
	}
	return ""
...
type GetAllProductIDsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProductIds    []string               `protobuf:"bytes,1,rep,name=product_ids,json=productIds,proto3" json:"product_ids,omitempty"`  // Danh sách ID sản phẩm
	StatusCode    int32                  `protobuf:"varint,2,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // Mã trạng thái HTTP
	Error         string                 `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`                              // Thông báo lỗi (nếu có)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetAllProductIDsResponse) Reset() {
	*x = GetAllProductIDsResponse{}
	mi := &file_order_order_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAllProductIDsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllProductIDsResponse) ProtoMessage() {}

func (x *GetAllProductIDsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_order_order_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllProductIDsResponse.ProtoReflect.Descriptor instead.
func (*GetAllProductIDsResponse) Descriptor() ([]byte, []int) {
	return file_order_order_proto_rawDescGZIP(), []int{8}
}

func (x *GetAllProductIDsResponse) GetProductIds() []string {
	if x != nil {
		return x.ProductIds
	}
	return nil
...
func (x *GetAllProductIDsResponse) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *GetAllProductIDsResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_order_order_proto_rawDesc = string([]byte{
	...
	,
	...
	0x72, 0x6f, 0x72, 0x32, 0xd8, 0x02, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x73, 0x12, 0x1b, 0x2e,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x49, 0x44, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x73,
	...
	,
...
var file_order_order_proto_goTypes = []any{
	...
	(*GetAllProductIDsRequest)(nil),    // 7: order.GetAllProductIDsRequest
	(*GetAllProductIDsResponse)(nil),   // 8: order.GetAllProductIDsResponse
}
var file_order_order_proto_depIdxs = []int32{
	...
	7, // 4: order.OrderService.GetAllProductIDs:input_type -> order.GetAllProductIDsRequest
	1, // 5: order.OrderService.CreateOrder:output_type -> order.CreateOrderResponse
	4, // 6: order.OrderService.GetProductIDs:output_type -> order.GetProductIDsResponse
	6, // 7: order.OrderService.CheckBoughtProduct:output_type -> order.CheckBoughtProductResponse
	8, // 8: order.OrderService.GetAllProductIDs:output_type -> order.GetAllProductIDsResponse
